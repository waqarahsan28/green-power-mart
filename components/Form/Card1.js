                ...
                <View style={styles.box2}>
                    <View style={styles.right}>
                        ...
                        <View style={styles.icons}>
                            ...
                            <View >
                                <Text style={styles.textContent}>35 Unit's</Text>
                                <Text style={styles.textContent1}>Location</Text>
                            </View>
                        </View>
                        <View style={styles.day}>
                            <Text style={styles.day1}>Day's:   </Text>
                            <Text style={styles.day2}>11 Nov - 22 Nov</Text>
                        </View>
