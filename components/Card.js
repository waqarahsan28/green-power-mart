...
const Card = (props) => {
  ...
  return (
    <TouchableOpacity
      ...
      {/* <Text style={{ alignSelf: 'center', marginTop: 10, fontSize: 20, fontWeight: 'bold' }}>EV CHARGING POINT </Text> */}
      ...
      <View style={styles.box1}>
        <View>
          <View style={styles.icons}>
            ...
            <View >
              <Text style={styles.textContent}>{props.cntype}</Text>
              <TouchableOpacity>
      ...
      <View style={styles.box2}>
        <View style={styles.right}>
          <View style={styles.time}>
            <Text style={styles.time1}>Date:  </Text>
            <Text style={styles.time2}>{props.date}</Text>
          </View>
          <View style={styles.day}>
            <Text style={styles.day1}>Level:   </Text>
            <Text style={styles.day2}>{props.level}</Text>
          </View>
